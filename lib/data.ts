...
export const chaptersContent: Record<string, ChapterContent> = {
  "les-racines": {
    title: "LES RACINES",
    text: "\"Avant, l'horizon était une ligne droite. On nous disait que le monde nous appartenait. Aujourd'hui, cette ligne tremble. Les racines sont là, mais le sol, lui, semble se dérober.\" L'adolescence est le moment où la construction de soi percute la réalité du monde. C'est ici que naît la première fracture : celle entre la sécurité du foyer et le vertige d'un futur que l'on ne maîtrise plus. Comment projeter son propre avenir quand l'éco-anxiété devient le nouveau bruit de fond de nos vies ?",
  ...
  "le-vertige": {
    title: "LE VERTIGE",
    text: "Le smartphone n'est plus un simple outil de communication : pour la génération 18-25 ans, il est devenu une fenêtre béante sur l'effondrement global. Dans l'obscurité d'une chambre, la lumière bleue ne se contente pas d'éclairer un visage ; elle diffuse un flux continu d'alertes qui saturent l'esprit. Ce \"scroll\" infini n'est pas une simple passivité. C'est une confrontation brutale avec l'éco-anxiété. L\’alerte permanente : Chaque titre sur le dérèglement climatique ou l'extinction des espèces agit comme une micro-agression cognitive, renforçant ce sentiment d'être \"suspendu\" face à un futur incertain. Le paradoxe de l'information : Être la génération la plus connectée de l'histoire signifie porter la charge mentale d'un monde en crise, tout en étant physiquement seul face à son écran. La saturation : Ce vertige est le point de bascule où le trop-plein d'informations paralyse l'action. On devient, malgré soi, le spectateur impuissant d'un désastre que l'on nous demande pourtant de réparer. « L'incertitude est le moteur d'une nouvelle forme d'engagement, mais elle commence souvent par ce silence lourd devant la lumière froide des écrans. »",
    video: "/video/vertige.mp4",
  },
  "la-boussole": {
    title: "LA BOUSSOLE",
    text: "\“Je suis engagée depuis plus de trois ans dans le mouvement écologiste. L\’écoanxiété est arrivée avec. J\’en souffre régulièrement. L\’état dans lequel nous laissons entrevoir notre futur n\’est pas acceptable. Il m\’arrive parfois de me dire que se battre ne sert plus à rien, qu\’il faut abandonner et arrêter de donner de l\’énergie pour un combat déjà perdu. Ce sentiment me poursuit au quotidien, dans tous les aspects de ma vie. J\’ai changé mon alimentation et ma façon de voir les choses. Je ne souhaite pas avoir d\’enfant, je ne veux pas laisser quelqu\’un vivre dans le monde que nous sommes en train de bâtir. J\’essaye pourtant de garder de l\’espoir. Si l\’écoanxiété touche tous les militants écologistes un jour ou l\’autre, nous nous remotivons toujours et continuons le combat.\” Marina, 19 ans",
...
les jeunes femmes et les étudiants en milieu urbain.`,
    iframe:
      '<iframe src="https://embed.kumu.io/1830091f2b16762285f2d0a937c672a3" width="940" height="600" frameborder="0"></iframe>', // Ou l'URL de ton graphique
  },
  "nouveaux-horizons": {
    title: "L'ÉVEIL",
    text: "\"Le futur n'est pas écrit. Il est dans chaque pas, chaque refus, chaque main tendue. On ne répare pas le monde tout seul, on le réinvente ensemble.\" L’horizon n’est plus suspendu. Il est simplement à redessiner. Nous avons exploré le vertige, ressenti le poids des chiffres et navigué dans le brouillard de l'incertitude. Mais au bout de ce voyage, une certitude demeure : l'impuissance est une illusion entretenue par l'isolement. L'éco-anxiété n'est pas une maladie à guérir, c'est le signal d'alarme d'une humanité qui refuse de s'éteindre. En reposant nos écrans, en retrouvant le contact de la terre et le regard de l'autre, la paralysie s'efface. L'action collective devient l'antidote au désespoir. Nous ne sommes plus les spectateurs d'une fin du monde, mais les architectes d'un monde qui commence. Un monde plus lent, plus juste, plus vivant. L'horizon ne nous attend pas, il nous appelle. Il est temps de sortir de la suspension.",
