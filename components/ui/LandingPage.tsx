...
const FloatingNode = ({ text, top, left, delay, color = "white" }: { text: string, top: string, left: string, delay: number, color?: string }) => (
  <motion.div
    ...
    transition={{ 
        ...
        y: { repeat: Infinity, duration: 6 + Math.random() * 2, ease: "easeInOut", delay: Math.random() },
        x: { repeat: Infinity, duration: 8 + Math.random() * 2, ease: "easeInOut", delay: Math.random() }
    }}
    style={{ top, left }}
    ...
    ${color === "red" ? "shadow-[0_0_20px_rgba(239,68,68,0.4),inset_0_0_10px_rgba(239,68,68,0.2)]" : 
      color === "cyan" ? "shadow-[0_0_20px_rgba(34,211,238,0.4),inset_0_0_10px_rgba(34,211,238,0.2)]" : 
  ...
  return (
    ...
    >
        ...
        <div className="absolute inset-0 w-full h-full z-10 pointer-events-none">
            <FloatingNode text="Incertitude" top="20%" left="15%" delay={0.5} color="red" />
            <FloatingNode text="Identité" top="25%" left="75%" delay={0.7} color="white" />
            <FloatingNode text="Futur flou" top="65%" left="10%" delay={0.9} color="white" />
            <FloatingNode text="Éco-anxiété" top="60%" left="80%" delay={1.1} color="cyan" />
        </div>
